...
if (is_dir($frontendDist)) {
    ...
    $staticExtensions = ['css', 'js', 'png', 'jpg', 'jpeg', 'gif', 'ico', 'svg', 'woff', 'woff2', 'ttf', 'eot', 'json', 'webmanifest'];
    $ext = pathinfo($uri, PATHINFO_EXTENSION);
    
    if (in_array($ext, $staticExtensions)) {
        $file = $frontendDist . $uri;
    ...
    // Servir index.html para cualquier otra ruta (SPA behavior)
